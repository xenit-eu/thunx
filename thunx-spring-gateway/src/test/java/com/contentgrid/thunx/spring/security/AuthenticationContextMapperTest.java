...
class AuthenticationContextMapperTest {
    ...
    void fromOidcUser() {
        ...
        var idToken = OidcIdToken.withTokenValue("dummy")
                ...
                .authTime(instant)
                .issuer("https://auth.contentgrid.com/auth/realms/my-org")
        ...
        assertThat(context.getDetails())
                .hasEntrySatisfying("claims", claims -> assertThat(claims)
                        ...
                        .containsEntry("iss", "https://auth.contentgrid.com/auth/realms/my-org")
                        .containsEntry("azp", "contentgrid-gateway"));
    }
