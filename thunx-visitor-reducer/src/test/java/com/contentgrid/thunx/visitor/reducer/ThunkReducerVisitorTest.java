...
class ThunkReducerVisitorTest {
    ...
    class CompareEquals {
        ...
        void compareEquals_simplify_non_equal() {
            ...
            Assertions.assertThat(ThunkExpression.maybeValue(ThunkReducerVisitor.DEFAULT_INSTANCE.visit(comparison).assertResultType(Boolean.class))).contains(false);
        }
        ...
        void compareEquals_simplify_equal() {
            var comparison = Comparison.areEqual(Scalar.of(5), Scalar.of(5));
            Assertions.assertThat(ThunkExpression.maybeValue(ThunkReducerVisitor.DEFAULT_INSTANCE.visit(comparison).assertResultType(Boolean.class))).contains(true);
        }
    }
    ...
    class Logical {
        ...
        void resolvableDisjunctions_someResolvableFalse() {
            ...
            var simplified = ThunkReducerVisitor.DEFAULT_INSTANCE.visit(disjunction);
            Assertions.assertThat(simplified).hasToString("EQ(document.security, 5)");
